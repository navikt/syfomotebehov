...
class OppfolgingstilfelleService
    ...
    constructor(
        ...
        fun receiveKOppfolgingstilfelle(kafkaOppfolgingstilfellePerson: KafkaOppfolgingstilfellePerson) {
            kafkaOppfolgingstilfellePerson.oppfolgingstilfelleList
                .sortedByDescending { oppfolgingstilfelle ->
                    oppfolgingstilfelle.start
                }.firstOrNull()
                ?.let { oppfolgingstilfelle ->
                    oppfolgingstilfelle.virksomhetsnummerList.forEach { virksomhetsnummer ->
                        val pPersonOppfolgingstilfelle =
                            oppfolgingstilfelleDAO.get(
                        ...
                        if (pPersonOppfolgingstilfelle == null) {
                            ...
                            val isPreviouslyProcessed =
                                kafkaOppfolgingstilfellePerson.previouslyProcessed(
        ...
        fun getActiveOppfolgingstilfeller(arbeidstakerFnr: String): List<PersonVirksomhetOppfolgingstilfelle> =
        ...
        fun getActiveOppfolgingstilfelleForArbeidstaker(arbeidstakerFnr: String): PersonOppfolgingstilfelle? =
            getActiveOppfolgingstilfelle(
                arbeidstakerFnr,
                getPOppfolgingstilfellerInActiveOppfolgingstilfelle(arbeidstakerFnr),
            )

        private fun getPOppfolgingstilfellerInActiveOppfolgingstilfelle(arbeidstakerFnr: String): List<PPersonOppfolgingstilfelle> {
            ...
            val activeOppfolgingstilfelleList =
            ...
            val expiredOppfolgingstilfelleList =
                oppfolgingstilfelleList.filterNot {
                    it.isSykmeldtLast16Days()
                }
        ...
        private fun getActiveOppfolgingstilfelle(
            ...
            val activeOppfolgingstilfeller: List<PersonOppfolgingstilfelle> =
                oppfolgingstilfelleList.map {
