...
class DialogmoteStatusService
    ...
    constructor(
        ...
        fun isDialogmotePlanlagtEtterDato(
            ...
            virksomhetsnummer?.let {
                dialogmoteDAO
                    .getAktiveDialogmoterPaVirksomhetEtterDato(
                        arbeidstakerFnr,
                        it,
                        dato,
                    ).isNotEmpty()
        ...
        private fun getNewestSavedEndring(existingDialogmoter: List<Dialogmote>): Dialogmote =
            existingDialogmoter.sortedWith(
                compareBy {
                    it.statusEndringTidspunkt
                },
            )[0]

        private fun isMoteInnkallingEllerEndring(statusEndringType: String): Boolean =
            DialogmoteStatusEndringType.INNKALT.name.equals(statusEndringType) ||
