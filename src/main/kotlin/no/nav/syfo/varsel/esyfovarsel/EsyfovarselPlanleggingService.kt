...
class EsyfovarselPlanleggingService(private val producer: EsyfovarselPlanleggingProducer) {
    ...
    fun planleggSvarMotebehovVarselTilNarmesteLeder(varselDato: LocalDate, arbeidstakerFnr: String, orgnummer: String) {
        planleggVarsel(varselDato, arbeidstakerFnr, orgnummer, HendelseType.NL_DIALOGMOTE_SVAR_MOTEBEHOV)
    }

    fun planleggSvarMotebehovVarselTilArbeidstaker(varselDato: LocalDate, arbeidstakerFnr: String, orgnummer: String) {
