            ...
            registry
                .counter(
                    ...
                    Tags.of(
                        ...
                        "info",
                        "motebehov",
                        if (harMotebehov) "ja" else "nei",
                        "dag",
                        dayInOppfolgingstilfelleMotebehovCreated?.toString().orEmpty(),
                        "skjematype",
        ...
        fun countDayInOppfolgingstilfelleMotebehovCreated(
            ...
            val navn =
                if (erInnloggetBrukerArbeidstaker) {
                    ...
                    "syfomotebehov_motebehov_besvart_oppfolgingstilfelle_dag_ag"
                }
            registry
                .counter(
                    navn,
                    Tags.of(
                        ...
                        if (harMotebehov) "ja" else "nei",
                        "forklaring",
                        if (harForklaring) "ja" else "nei",
                        "dag",
                        dayInOppfolgingstilfelleMotebehovCreated.toString(),
                        "skjematype",
                        when (motebehovSkjemaType) {
                            MotebehovSkjemaType.MELD_BEHOV -> "meldbehov"
                            MotebehovSkjemaType.SVAR_BEHOV -> "svarbehov"
