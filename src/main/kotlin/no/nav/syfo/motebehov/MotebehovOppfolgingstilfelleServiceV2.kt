...
@Service
class MotebehovOppfolgingstilfelleServiceV2
    @Inject
    constructor(
        ...
        fun createMotebehovForArbeidgiver(
            ...
            val motebehovStatus =
                motebehovStatusServiceV2.motebehovStatusForArbeidsgiver(
                    arbeidstakerFnr,
                    isOwnLeader,
                    nyttMotebehov.virksomhetsnummer,
                )
            ...
            if (activeOppfolgingstilfelleExists && motebehovStatus.isMotebehovAvailableForAnswer()) {
                val storedMotebehovFormSubmission =
                    storeNyttMotebehovForArbeidsgiver(
                        arbeidstakerFnr,
                        nyttMotebehov,
                        innloggetFnr,
        ...
        fun createMotebehovForArbeidstaker(
            ...
            if (activeOppolgingstilfelle != null) {
                ...
                val virksomhetsnummerList =
                    if (motebehovStatus.isMotebehovAvailableForAnswer()) {
                        oppfolgingstilfelleService
                            .getActiveOppfolgingstilfeller(arbeidstakerFnr)
                            .map {
                ...
                if (virksomhetsnummerList.isNotEmpty()) {
                    ...
                    throwCreateMotebehovConflict(
                        "Failed to create Motebehov for Arbeidstaker: Found no Virksomhetsnummer with active Oppfolgingstilfelle",
                    )
                }
            } else {
                metric.tellHendelse(METRIC_CREATE_FAILED_ARBEIDSTAKER)
