...
val mockArbeidsgiverSvarJaOnskerSykmelderFormSnapshot =
    FormSnapshot(
...
val mockArbeidsgiverSvarNeiFormSnapshot =
    FormSnapshot(
        MotebehovFormIdentifier.ARBEIDSGIVER_SVAR,
        MOCK_SNAPSHOTS_FORM_SEMANTIC_VERSION,
        listOf(
...
val mockArbeidsgiverMeldOnskerSykmelderOgTolkFormSnapshot =
    FormSnapshot(
...
val mockArbeidstakerSvarJaFormSnapshot =
    FormSnapshot(
...
val mockArbeidstakerSvarNeiFormSnapshot =
    FormSnapshot(
        MotebehovFormIdentifier.ARBEIDSTAKER_SVAR,
        "1.0.0",
        listOf(
...
val mockArbeidstakerMeldSnapshot =
    FormSnapshot(
